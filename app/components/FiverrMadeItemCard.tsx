...
const FiverrMadeItemCard = ({ title, author, imgUrl }: Props) => {
  return (
    <div className="relative group mb-10">
      <div className="relative group-hover:bg-gradient-to-t group-hover:from-black group-hover:to-black/50 group-hover:rounded-md transition-colors duration-300">
