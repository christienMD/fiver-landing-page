...
const Hero = () => {
  return (
    <section className="px-4 sm:px-6 md:px-10 flex flex-col gap-8 items-center justify-center container mx-auto md:max-w-7xl bg-gradient-to-t from-green-950 to-green-900 h-[500px] mt-10 pt-7 rounded-lg">
